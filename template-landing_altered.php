<?php /* Template Name: Landing */ get_header(); ?>
    ...
    <header class="jumbotron bg-inverse text-xs-center center-vertically poster" role="banner">
      <div class="container">
        ...
        <a href="<?php echo esc_url( home_url( '/' ) ); ?>register" class="btn btn-block"><span class="bg-inverse p-l"><?php $count = count( get_users( array( 'role' => 'subscriber' ) ) ); if ($count <= 100) { $promo_left = 100 - $count; echo $promo_left.' promo discount slots left. Subscribe Now!'; } ?></span></a>
      </div>
    </header>
      ...
      <div class="container">
        ...
        <div class="row p-y-3">
          <div class="col-md-6 board-wrapper p-xxl">
            <div class="board">
            <p class=""><strong>Contact ChillySpaces!</strong> <br/>Please leave your</p>
            </div>
          </div>
          <div class="col-md-6 p-xl bg-white margin-left-n shadow contact-form">
            ...
            <p class="text-xs-center">We'll get back to you<br>as soon as possible!</p>
            <form>
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group has-icon-left form-control-name">
                    <label class="sr-only" for="inputName">First name*</label>
                    <input type="text" class="form-control form-control-lg" id="inputFirstName" placeholder="Your name">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group has-icon-left form-control-email">
                    <label class="sr-only" for="inputLastName">Last name*</label>
                    <input type="email" class="form-control form-control-lg" id="inputLastName" placeholder="Email address" autocomplete="off">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group has-icon-left form-control-email">
                ...
                <div class="col-md-12">
                  <div class="form-group has-icon-left form-control-email">
                    ...
                    <input type="email" class="form-control form-control-lg" id="inputPhone" placeholder="Email address" autocomplete="off">
                  </div>
                </div>
				<div class="col-md-12">
                  <div class="form-group has-icon-left form-control-email">
                    <label class="sr-only" for="inputCompany">Company name</label>
                    <input type="email" class="form-control form-control-lg" id="inputCompany" placeholder="Email address" autocomplete="off">
                  </div>
                </div>
                <div class="col-md-12">
