<?php /* Template Name: Landing */ get_header(); ?>
		...
		<div class="container">
			...
			<!--<div class="well">
				<div class="bg-inverse">-->
					<a href="https://chillyspaces.eventbrite.com" class="btn btn-edgy bg-inverse">
					<h3 class="text-uppercase">ChillySpaces grand opening: october 3rd!</h3>
					<h4><strong>12:00 - 15:00</strong></h4>
					<h5>Join us for our opening celebration at the very first ChillySpace at Cedars Lebanese restaurant in Amsterdam! <br/>Sign up for our Early Chillies membership by October 8th and receive 50% discount on your first 6 months membership!</h4>
					</a>
				<!--</div>
			</div> -->
    ...
    <section id="values" class="section-values bg-inverse text-xs-center">
      <div class="container">
        ...
        <!-- Values 
						Values list moved to About Us page
        ================================================== 
      ...
      <div class="container">
        ...
        <div class="row p-y-3">
          <div class="col-md-6 board-wrapper p-xxl">
            <div class="board">
            <p class=""><strong>Stay in touch with ChillySpaces!</strong> Leave your contact info here, and we'll keep you up to date with all big <em>ChillySpaces</em> news!</p>
            </div>
          </div>
          <div class="col-md-6 p-xl bg-white margin-left-n shadow contact-form">
            <h3 class="text-xs-center">Please leave your contact information</h3>
            <p class="text-xs-center">We'll get back to you as soon as possible!</p>
            <form>
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group has-icon-left form-control-name">
                    <label class="sr-only" for="inputName">First name*</label>
                    <input type="text" class="form-control form-control-lg" id="inputFirstName" placeholder="First name">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group has-icon-left form-control-name">
                    <label class="sr-only" for="inputLastName">Last name*</label>
                    <input type="name" class="form-control form-control-lg" id="inputLastName" placeholder="Last name" autocomplete="off">
                  </div>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                  <div class="form-group has-icon-left form-control-phone">
                    ...
                    <input type="phone" class="form-control form-control-lg" id="inputPhone" placeholder="Phone number" autocomplete="off">
                  </div>
                </div>
				<div class="col-md-12">
                  <div class="form-group has-icon-left form-control-name">
                    <label class="sr-only" for="inputCompany">Company name</label>
                    <input type="name" class="form-control form-control-lg" id="inputCompany" placeholder="Company Name" autocomplete="off">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                    <button type="submit" class="btn btn-edgy invert btn-block">Send</button>
                  </div>
                </div>
              </div>
            </form>
